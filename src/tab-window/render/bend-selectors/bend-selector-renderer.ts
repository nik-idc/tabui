import { createSVGCircle, createSVGLine, createSVGPath } from "../../../misc/svg-creators";
...
export class BendSelectorRenderer {
    ...
    public render(): void {
        ...
        this._bendCircle.setAttribute("fill", "red");
        this._bendCircle.style.cursor = "pointer";
        this._svg.appendChild(this._bendCircle);

        this._bendCircle.addEventListener("mousedown", this.onCircleMouseDown.bind(this));
    }
    ...
    private onDocumentMouseMove(event: MouseEvent) {
        if (this._isDragging === false || this._bendCircle === undefined || this._bendPath === undefined) return;
